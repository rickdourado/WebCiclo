...
4. **SEMPRE** seguir as convenções de nomenclatura e organização
5. **SEMPRE** aplicar as regras de desenvolvimento sem exceção
6. **SEMPRE** ative o ambiente virtual correto: Venv ("source .venv/bin/activate")
7. **SEMPRE** unifique os changelogs usando primeiramente o dia em que foram feitos, mantendo o padrão AAAA-MM-DD.md. Os logs deverão ser armazenados na pasta documentacao/logs
8. **SEMPRE** que precisar criar um script para uma tarefa temporária, delete-o depois
9. **SEMPRE** que criar um arquivo de documentação, coloque-o na pasta documentacao.
10. **SEMPRE** utilize o uv como principal comando, evitando o uso de pip.

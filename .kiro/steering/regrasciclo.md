...
O WebCiclo.Carioca é um sistema de curadoria de cursos desenvolvido com Flask para frontend e backend, utilizando HTML5, CSS3 e JavaScript Vanilla para a interface. O sistema é projetado para ser hospedado na plataforma PythonAnywhere.
...
- **Changelog:** Registrar alterações diárias em arquivos com formato `AAAA-MM-DD.md` na pasta `documentacao/changelogs`. Sempre que houver alterações novas, atualize o changelog do dia, e não crie um novo.

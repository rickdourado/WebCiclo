...
def create_course():
    try:
        ...
        course_data = {
                ...
                'horario_inicio': ', '.join(request.form.getlist('horario_inicio[]')) if request.form.getlist('horario_inicio[]') else '',
                'horario_fim': ', '.join(request.form.getlist('horario_fim[]')) if request.form.getlist('horario_fim[]') else '',
